...
import Logo from "../../../images/logo/viblo.svg";
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <div>
          <NavLink to="/admin">
            <img src={Logo} alt="Logo" height={15} width={90} />
          </NavLink>
        </div>
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      ...
                      >
                        <ul className="my-2.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/admin/statistics"
                              className={({ isActive }) =>
